...
public class ProduitServiceImpl implements ProduitService{
	...
	public List<Produit> getProduitsByIds(List<Long> produitIds) {
	    return produitRepository.findAllById(produitIds);
	}
	
	
	public List<Produit> getProduitsWithoutCategorie() {
	    return produitRepository.findByCategorieIsNull();
	}
